				...
				<div class="col-12 col-lg-9 col-xl-7">
					<div class="card shadow-2-strong card-registration"
						...
						<div class="card-body p-4 p-md-5">
							...
							<form action="RegisterS" method="post" id="register-form">
									...
									<div class="col-md-6 mb-4 d-flex align-items-center">
										...
										<div class="form-outline datepicker w-100">
											<input type="text" name="dob"
												...
												required="required" /> <label for="birthdayDate"
									...
									<div class="col-md-6 mb-4 pb-2">
										...
										<div class="form-outline">
											<input type="password" name="pass" id="pass"
												class="form-control form-control-lg" required="required"
												onkeyup="isValidPassword(this,'pass')" /> <label
												class="form-label" for="emailAddress">Password</label>
										</div>
