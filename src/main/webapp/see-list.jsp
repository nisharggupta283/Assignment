...
<body>
	...
	<form action="AjexServletS?mode=deleteSelected" method="post">
							...
							<div class="col">
								<table class="styled-table" id="to-append">
									<thead>
										<tr>
											<!--Header  -->
											<th><input type="checkbox" id="all" value="all"
												name="all"> Select All</th>
											<th>NAME</th>
											<th>ID</th>
											<th>PHONE</th>
											<th>DOB</th>
									...
									<tbody id="to-delete">
										...
										<tr class="<%=count%>" id="tr<%=loginInfo.getUserID()%>">
											<td><input type="checkbox"
												value="<%=loginInfo.getUserID()%>" name="checkbox"></td>
